    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">List  CV User  :</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
            <!-- Page Content -->
                                ...
                                <div class="table-responsive table-bordered">
                                    <table class="table">
                                        ...
                                        <tbody>
				                	      ...
				                	      <td>{!!$tampil->status!!}</td>   
				                        	<td>{!! link_to(route('cv.show',$tampil->id_user),'download',$tampil->nama)!!}</td>     
                                            <td>{!! link_to(route('cv.edit',$tampil->id_user),'Edit') !!}</td>     
