    ...
    <body>
        ...
        <div id="wrapper">
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        ...
                        @if(Sentinel::getUser()->hasAccess('ubahuser'))
                            ...
                            <li>
                                <a href="tables.html"><i class="fa fa-table fa-fw"></i>Lihat data user</a>
                            </li>
                            ...
                            <li>
                                <a href="#"><i class="fa fa-files-o fa-fw"></i>Download pdf user</a>
                            </li>
                            <li>
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Upload CV :</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
            <!-- Page Content -->
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                               Masukan data cv di bawah:
                            </div>
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-lg-6">
                               
            {!! Form::open(array('route'=>'cv.store','method'=>'POST','files'=>true)) !!}

                                    <div class="form-group">
                                               
                                          
                                   {!! Form::label('file','Masukan CV(dengan extensi pdf,docx,doc):')!!}
